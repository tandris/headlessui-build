...
export declare let TabGroup: import("vue").DefineComponent<{
    ...
    [key: string]: any;
}>[] | null | undefined, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, "change"[], "change", import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<{
    vertical: boolean;
    manual: boolean;
    as: string;
    defaultIndex: number;
